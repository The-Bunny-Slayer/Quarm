...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function createChecklistItem(text) { /* ... unchanged ... */ }
    function renderObtainmentTree(obtainmentData) { /* ... unchanged ... */ }
    function renderBreakdown(data, itemName) { /* ... unchanged ... */ }
    async function getObtainInfo(itemId, itemName) { /* ... unchanged ... */ }
    ...
    // Re-pasting the functions I marked as unchanged to be safe
