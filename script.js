...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function showItemTooltip(item, event) { /* ... same as before ... */ }
    function hideTooltip() { /* ... same as before ... */ }
    function createChecklistItem(text) { /* ... same as before ... */ }
    function renderObtainmentTree(obtainmentData) { /* ... same as before ... */ }
    function renderBreakdown(data, itemName) { /* ... same as before ... */ }
    async function getObtainInfo(itemId, itemName) { /* ... same as before ... */ }
    ...
    function drawGridView() {
        ...
        currentItems.forEach(item => {
            ...
            // Add listeners to both the image and the name
            ...
            // The mousemove listener is not strictly needed if we position on enter
...
// Repasting the functions I left out
showItemTooltip = function(item, event) {
    let flags = [];
...
createChecklistItem = function(text) {
...
renderObtainmentTree = function(obtainmentData) {
...
renderBreakdown = function(data, itemName) {
...
getObtainInfo = async function(itemId, itemName) {
